...
# Either teams score has a range of 0-9, and the ref won't say the same string 
# every time e.g.
...
def scoreboard(string):
    ...
    score_dict = {'nil': 0, 'one': 1, 'two': 2, 'three': 3, 'four': 4, 
                    'five': 5, 'six': 6, 'seven': 7, 'eight': 8, 'nine': 9}
        
    final = [score_dict[word] for word in string_split 
