...
# Your function will iterate through the members of the sequence in order until 
# the provided function returns true; at which point your function will return 
# that item's index.
